/*
  ...
  - Made the column `priceBought` on table `CryptoPortfoliosOwned` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_CryptoPortfoliosOwned" ("cryptoId", "id", "portfolioId", "priceBought", "quantity") SELECT "cryptoId", "id", "portfolioId", "priceBought", "quantity" FROM "CryptoPortfoliosOwned";
